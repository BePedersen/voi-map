...
# --- Config ---
kml_path = "zones/moss.kml"
output_html = "voi-moss.html"
map_center = [59.4340, 10.6570]
...
# --- Fetch VOI scooters ---
url = "https://api.entur.io/mobility/v2/gbfs/v3/voimoss/vehicle_status"
...
if response.status_code == 200:
    ...
    trips_today = track_trips(bikes, "moss")
