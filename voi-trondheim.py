...
# --- Config ---
kml_path = "zones/trondheim.kml"
output_html = "voi-trondheim.html"
map_center = [63.4305, 10.3951]
...
# --- Fetch VOI scooters ---
url = "https://api.entur.io/mobility/v2/gbfs/v3/voitrondheim/vehicle_status"
...
if response.status_code == 200:
    ...
    trips_today = track_trips(bikes, "trondheim")
