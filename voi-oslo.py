...
# --- Config ---
kml_path = "zones/oslo.kml"
output_html = "voi-oslo.html"
map_center = [59.9139, 10.7522]
...
# --- Fetch VOI scooters ---
url = "https://api.entur.io/mobility/v2/gbfs/v3/voioslo/vehicle_status"
...
if response.status_code == 200:
    ...
    trips_today = track_trips(bikes, "oslo")
