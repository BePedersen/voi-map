...
# --- Config ---
kml_path = "zones/lillestrom.kml"
output_html = "voi-lillestrom.html"
map_center = [59.9556, 11.0500]
...
# --- Fetch VOI scooters ---
url = "https://api.entur.io/mobility/v2/gbfs/v3/voilillestrom/vehicle_status"
...
if response.status_code == 200:
    ...
    trips_today = track_trips(bikes, "lillestrom")
